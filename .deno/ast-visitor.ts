...
import { AstDefaultMapper, IAstPartialMapper, astMapper, IAstMapper } from './ast-mapper.ts';
import { ReplaceReturnType } from './utils.ts';
        ...
        get() {
            return function (this: Visitor, ...args: any[]) {
                ...
                if (!impl) {
                    ...
                    return orig.apply(this.mapper, args);
                }
