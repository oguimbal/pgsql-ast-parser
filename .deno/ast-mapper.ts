...
export interface IAstPartialMapper {
  ...
  transaction?: (
    val: a.CommitStatement | a.RollbackStatement | a.StartTransactionStatement
  ) => a.Statement | nil;
  createIndex?: (val: a.CreateIndexStatement) => a.Statement | nil;
  alterTable?: (st: a.AlterTableStatement) => a.Statement | nil;
  dropColumn?: (
    change: a.TableAlterationDropColumn,
    table: a.QNameAliased
  ) => a.TableAlteration | nil;
  renameConstraint?: (
    change: a.TableAlterationRenameConstraint,
    table: a.QNameAliased
  ) => a.TableAlteration | nil;
  setTableOwner?: (
    change: a.TableAlterationOwner,
    table: a.QNameAliased
  ) => a.TableAlteration | nil;
  renameColumn?: (
    change: a.TableAlterationRenameColumn,
    table: a.QNameAliased
  ) => a.TableAlteration | nil;
  renameTable?: (
    change: a.TableAlterationRename,
    table: a.QNameAliased
  ) => a.TableAlteration | nil;
  alterColumn?: (
    change: a.TableAlterationAlterColumn,
    inTable: a.QNameAliased
  ) => a.TableAlteration | nil;
  setColumnType?: (
  ...
  addConstraint?: (
    change: a.TableAlterationAddConstraint,
    inTable: a.QName
  ) => a.TableAlteration | nil;
  addColumn?: (
    change: a.TableAlterationAddColumn,
    inTable: a.QName
  ) => a.TableAlteration | nil;
  createColumn?: (col: a.CreateColumnDef) => a.CreateColumnDef | nil;
  likeTable?: (
    col: a.CreateColumnsLikeTable
  ) => a.CreateColumnDef | a.CreateColumnsLikeTable | nil;
  ...
  createMaterializedView?: (
    val: a.CreateMaterializedViewStatement
  ) => a.Statement | nil;
...
export class AstDefaultMapper implements IAstMapper {
  ...
  raise(val: a.RaiseStatement): a.Statement | nil {
    return assignChanged(val, {
      formatExprs:
        val.formatExprs && arrayNilMap(val.formatExprs, (x) => this.expr(x)),
      using:
        val.using &&
        arrayNilMap(val.using, (u) => {
  ...
  set(st: a.SetStatement): a.SetStatement | nil {
    const value = st.value === "default" ? st.value : this.expr(st.value);
    if (!value) {
      return null;
    }
  ...
  alterColumn(
    ...
    switch (change.alter.type) {
      ...
      case "drop not null":
        ...
        break;
      case "add generated":
        alter = this.alterColumnAddGenerated(
          change.alter,
          inTable,
          change.column
        );
  ...
  createColumn(col: a.CreateColumnDef): a.CreateColumnDef | nil {
    ...
    const constraints =
      arrayNilMap(col.constraints, (m) => this.constraint(m)) ?? undefined;
